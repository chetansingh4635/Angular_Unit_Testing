...
@Injectable()
export class DashboardTimesheetPastResolver implements Resolve<Array<ProviderDashboardTimesheet>> {
  ...
  resolve(route: ActivatedRouteSnapshot, state: RouterStateSnapshot): Observable<Array<ProviderDashboardTimesheet>> {
    return this.timesheetLookup.getDashboardTimesheets(false);
  }
}
