...
@Injectable()
export class DashboardTimesheetDeclinedResolver implements Resolve<Array<ProviderDashboardTimesheet>> {
  ...
  resolve(route: ActivatedRouteSnapshot, state: RouterStateSnapshot): Observable<Array<ProviderDashboardTimesheet>> {
    return this.timesheetLookup.getDashboardTimesheets(false, true);
  }
}
