...
@Injectable()
export class TimesheetListDeclinedResolver implements Resolve<QueryPagingResult<ProviderDashboardTimesheet>> {
  ...
  resolve(route: ActivatedRouteSnapshot, state: RouterStateSnapshot): Observable<QueryPagingResult<ProviderDashboardTimesheet>> {
    return this.timesheetLookup.getProviderTimesheetList(false, true);
  }
}
