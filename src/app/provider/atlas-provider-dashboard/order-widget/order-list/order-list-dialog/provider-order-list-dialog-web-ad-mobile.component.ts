...
import { ApplicationInsightsCustomDispositionConstants } from '../../../../../shared/constants/application-insights-custom-constants';
...
@Component({
  selector: 'jclt-provider-order-list-dialog-web-ad-mobile',
  templateUrl: './provider-order-list-dialog-web-ad-mobile.component.html',
...
export class ProviderOrderListDialogWebAdMobileComponent implements OnInit {
  @Input()
  public selectedJobOpportunity: ProviderOrderList;
  @Input()
  ...
  public onApply(jobOpportunity) {
    ...
    this.providerOrderApplyService.submitOrderApply(opportunity).subscribe(
      (() => {
        ...
        this.applicationInsightsService.logJobApplyApplicationInsights(ApplicationInsightsCustomDispositionConstants.SUCCESS, opportunity);
      ...
      () => {
        ...
        this.applicationInsightsService.logJobApplyApplicationInsights(ApplicationInsightsCustomDispositionConstants.FAILURE, opportunity);
      }
    );
  }
