...
@Component({
  selector: 'jclt-atlas-timesheet-widget-mobile',
  templateUrl: './atlas-timesheet-widget-mobile.component.html'
})
export class AtlasTimesheetWidgetMobileComponent implements OnInit, OnDestroy {
  ...
  private init() {
    ...
    this.currentTimesheets = this.currentTimesheets.slice(0, (5 - this.numPastDisplay - this.numDeclinedDisplay))
