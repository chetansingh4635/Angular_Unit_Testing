...
export class BookingRecruitingConsultantLookupResolver implements Resolve<Array<CompanyEmployeeLookup>> {
  ...
  resolve(route: ActivatedRouteSnapshot, state: RouterStateSnapshot): Observable<Array<CompanyEmployeeLookup>> {
    return this.service.getBookingRecruitingConsultantLookup();
  }
}
