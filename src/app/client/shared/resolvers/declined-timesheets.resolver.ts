...
@Injectable()
export class DeclinedTimesheetsResolver implements Resolve<Array<ReviewedTimesheet>> {
  ...
  resolve(route: ActivatedRouteSnapshot, state: RouterStateSnapshot): Observable<Array<ReviewedTimesheet>> {
    return this.reviewedTimesheetService.getTimesheetListByClientStatus(TimesheetClientStatuses.Declined);
  }
