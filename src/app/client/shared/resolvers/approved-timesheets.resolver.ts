...
@Injectable()
export class ApprovedTimesheetsResolver implements Resolve<Array<ReviewedTimesheet>> {
  ...
  resolve(route: ActivatedRouteSnapshot, state: RouterStateSnapshot): Observable<Array<ReviewedTimesheet>> {
    return this.reviewedTimesheetService.getTimesheetListByClientStatus(TimesheetClientStatuses.Approved);
  }
